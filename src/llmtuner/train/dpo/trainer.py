...
class CustomDPOTrainer(DPOTrainer):
    def __init__(
        ...
        **kwargs,
        ...
        logging.basicConfig(filename='../LLM_rec/dpo_training.log', level=logging.INFO)
    ...
    def get_batch_loss_metrics(
        ...
        losses, chosen_rewards, rejected_rewards = self.dpo_loss(
            ...
            reference_chosen_logps,
            reference_chosen_logps,
            # torch.ones_like(reference_chosen_logps),
            # torch.ones_like(reference_chosen_logps),
        )
        ...
        # self.logger.info(f"policy_chosen_logps: {policy_chosen_logps}")
        # self.logger.info(f"policy_rejected_logps: {policy_rejected_logps}")
        # self.logger.info(f"chosen_labels: {chosen_labels}")
